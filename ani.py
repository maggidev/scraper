...
class AnimeFireAPI:
    ...
    async def get_video_links(self, ep_name: str, ep_url: str, anime_slug: str) -> Episode:
        """Extrai links de vídeo e gera thumbnail corrigida."""
        async with self.semaphore:
            try:
                ep_number = ep_url.split("/")[-1]
                
                # Ajuste para dublados: usa o slug sem '-dublado' para a imagem
    ...
    async def run_automation(self):
        ...
        try:
            with open("full_db.json", "r", encoding="utf-8") as f:
        ...
        for i in range(0, len(links_to_process), batch_size):
            ...
            with open("full_db.json", "w", encoding="utf-8") as f:
